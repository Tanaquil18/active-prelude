  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <task workspace="3cm">
        ...
        <statement>
          <xsl:apply-templates select="$statement-ol[1]/*"/>
        </statement>
        <hint>
          <xsl:apply-templates select="$hint-ol[1]/*"/>
        </hint>
        <answer>
          <xsl:apply-templates select="$answer-ol[1]/*"/>
        </answer>
        <solution>
          <xsl:apply-templates select="$solution-ol[1]/*"/>
        </solution>
      </task>
      <xsl:call-template name="build-task">
